...
export class CreateUsers1693579406088 implements MigrationInterface {
    name = 'CreateUsers1693579406088'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "photos" ADD CONSTRAINT "FK_b1426233b7de5c32c767984fa91" FOREIGN KEY ("adId") REFERENCES "ads"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
